...
public class Logi {
    ...
    public static String przelewWykonujacyLog(String rachunek, String kwota,String tresc,int id /* tutaj bedzie id zmiennej sesyjnej*/)
    {
        String sql="INSERT INTO logi(typ,rachunek,kwota,tresc,uzytkownik) VALUES('Przelew wychodzacy','"+rachunek+"','"+kwota+"','"+tresc+"','"+id+"','"+"')";
        return sql;
    }

    public static String przelewPrzyjmujacyLog(String rachunek /*od kogo przelew*/, String kwota,String tresc,int id)
    {
        String sql="INSERT INTO logi(typ,rachunek,kwota,tresc,uzytkownik) VALUES('Przelew przychodzacy','"+rachunek+"','"+kwota+"','"+tresc+id+"','"+"')";
        return sql;
    }
    public static String logLogowanie(int id)
    {
